#-------------------------------------------------
#
# Project created by QtCreator 2015-01-28T23:13:53
#
#-------------------------------------------------
...
TARGET = VMSService_video
TEMPLATE = app

DESTDIR = ../_VMS_Product
QMAKE_LIBDIR += ../_VMS_Product

LIBS += -lWtsapi32 -lws2_32
...
HEADERS  += ../_servicebase/addblackinforeceivesocket.h \
